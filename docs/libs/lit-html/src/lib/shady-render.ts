 ...
 * output.
 */
const prepareTemplateStyles = (scopeName: string, renderedDOM: DocumentFragment, template?: Template) => {
...
export const render = (
  ...
  if (firstScopeRender) {
    ...
    prepareTemplateStyles(scopeName, renderContainer as DocumentFragment, template);
