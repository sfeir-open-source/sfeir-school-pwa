...
Reveal.addEventListener('ready', function() {
  ...
  QUnit.test('Initial slides classes', function(assert) {
    ...
    assert.ok(
      document.querySelectorAll('.reveal .slides section.stack')[0].querySelectorAll('.future').length > 0,
  ...
  QUnit.test('Reveal.isLastSlide after vertical slide', function(assert) {
    ...
    assert.strictEqual(
      Reveal.isLastSlide(),
      true,
      'true after Reveal.slide( 1, 1 ) and then Reveal.slide( ' + lastSlideIndex + ', 0 )'
    );
  });
  ...
  QUnit.test('Reveal.getSlide', function(assert) {
    ...
    assert.equal(
      Reveal.getSlide(1, 0),
      document.querySelector('.reveal .slides>section:nth-child(2)>section:nth-child(1)'),
      'v index 0 returns first vertical child'
    );
    assert.equal(
      Reveal.getSlide(1, 1),
      document.querySelector('.reveal .slides>section:nth-child(2)>section:nth-child(2)'),
  ...
  QUnit.test('Reveal.getSlideBackground', function(assert) {
    ...
    assert.equal(
      ...
      document.querySelector('.reveal .backgrounds>.slide-background:nth-child(2) .slide-background:nth-child(2)'),
      'v index 0 returns first vertical child'
    );
    assert.equal(
      Reveal.getSlideBackground(1, 1),
      document.querySelector('.reveal .backgrounds>.slide-background:nth-child(2) .slide-background:nth-child(3)'),
      'v index 1 returns second vertical child'
    );
  ...
  QUnit.test('Current fragment', function(assert) {
    ...
    Reveal.prev();
    assert.strictEqual(
      fragmentSlide.querySelector('.fragment.current-fragment').getAttribute('data-fragment-index'),
      lastFragmentIndex,
